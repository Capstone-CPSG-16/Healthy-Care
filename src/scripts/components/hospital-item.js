class HospitalItem extends HTMLElement {
  ...
  render() {
    ...
    if (this._hospital) {
      this.innerHTML = `
      <div class="card h-100 card-rs" data-aos="zoom-in" data-aos-duration="600">
        ...
        <div class="card-footer text-center align-items-center">
          <a class="btn btn-success btn-lokasi w-100 text-center" target="_blank" rel="noopener" href="https://www.google.com/maps/search/${this._hospital.name}">
            <span class="iconify ml-2" data-icon="fa-solid:location-arrow" style="color: white;" data-width="15">
            </span> Lihat Lokasi
          </a> 
        </div>
      </div>
